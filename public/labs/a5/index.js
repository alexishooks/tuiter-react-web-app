...
let arrayOfLogs = [numberVariable, floatingPointNumber, stringVariable,
booleanVariable, isNumber, isString, isBoolean]

let printToConsoleType = arrayOfLogs.map(i => console.log(i))
...
let arrayOfLogs2 = [true1, false1, false2, true2, true3,
  true4, true5, false3, sortaTrue, notTrue]
let printToConsoleBoolean = arrayOfLogs2.map(i => console.log(i))
